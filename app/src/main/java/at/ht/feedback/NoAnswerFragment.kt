...
import kotlinx.android.synthetic.main.fragment_no_answer.*
...
class NoAnswerFragment : Fragment() {
    ...
    private fun navigateToQuestion(it: View) {
        it.findNavController().navigate(R.id.action_noAnswerFragment_to_questionFragment)
    }

    private fun navigateToWelcome(it: View) {
        it.findNavController().navigate(R.id.action_noAnswerFragment_to_welcomeFragment)
    }
